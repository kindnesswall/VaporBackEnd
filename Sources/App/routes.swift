...
public func routes(_ app: Application) throws {
    ...
    //Routes User Profile
    publicRouter.get(uris.profile_id, use: userProfileController.show)
    ...
    tokenProtected.get(uris.gifts_userRegistered, use: userRegisteredGifts.index)
    tokenProtected.get(uris.gifts_userDonated, use: userDonatedGifts.index)
    tokenProtected.get(uris.gifts_userReceived, use: userReceivedGifts.index)
    tokenProtected.get(uris.gifts_userRequested, use: userRequestedGifts.index)
    ...
    tokenProtected.get(uris.gifts_userRegistered_paginate, use: userRegisteredGifts.paginatedIndex)
    tokenProtected.get(uris.gifts_userDonated_paginate, use: userDonatedGifts.paginatedIndex)
    tokenProtected.get(uris.gifts_userReceived_paginate, use: userReceivedGifts.paginatedIndex)
    tokenProtected.get(uris.gifts_userRequested_paginate, use: userRequestedGifts.paginatedIndex)
