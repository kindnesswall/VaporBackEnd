...
//        logMiddleware)
    ...
    //Routes Gift Request
    charityProtected.get(uris.gifts_request_id, use: giftRequestController.requestGift)
    ...
    tokenProtected.get(uris.phone_visibility_check_id, use: userPhone.checkPhoneNumberAccessibility)
